WOOOF animates creation of an object model from a scenario.
...
a text file is produced with the objects and experimental output representing Random
walks through the model and queries on parts of the model.
...
Ideas related to Object-oriented Ontology (see the book Object-oriented Ontology by Graham Harman) can also be tested by combining
with ideas from Object Oriented Programming (OOP).
...
OOP ideas behind the scenarios are:
...
Aside from the question of whether they are in anyway related to reality they have been useful in directing 
